...
for (label, balance_name) in [
    ...
    ("RebelYell", "/Game/Gear/Weapons/AssaultRifles/Atlas/_Shared/_Design/_Unique/RebellYell/Balance/Balance_ATL_AR_RebelYell"),
    ...
    ("Frostbolt", "/Game/Gear/Weapons/SniperRifles/Dahl/_Design/_Unique/Frostbolt/Balance/Balance_SR_DAL_ETech_Frostbolt"),
    ("IntroGun", "/Game/Gear/Weapons/Pistols/Jakobs/_Shared/_Design/_Unique/IntroMission/Balance/Balance_PS_JAK_IntroGun"),
    ...
    ("StabbyMcStabs", "/Game/Gear/Weapons/Shotguns/Tediore/_Shared/_Design/_Unique/StabbyMcStabsalot/Balance/Balance_SG_Tediore_05_StabbyMcStabs"),
    ...
    ("LiquidCoolin", "/Game/Gear/Weapons/Pistols/ChildrenOfTheVault/_Shared/_Design/_Unique/LiquidCooling/Balance/Balance_PS_COV_05_LiquidCoolin"),
    ...
    ("WizardsPipe", "/Game/Gear/Weapons/SMGs/Hyperion/_Shared/_Design/_Unique/WizardPipe/Balance/Balance_SM_HYP_05_WizardsPipe"),
    ("ThunderAni", "/Game/Gear/Weapons/AssaultRifles/ChildrenOfTheVault/_Shared/_Design/_Unique/ThunderAnima/Balance/Balance_AR_COV_ThunderAni"),
    ...
    ("Used", "/Game/Gear/Weapons/SniperRifles/Hyperion/_Shared/_Design/_Unique/AntGreatBow/Balance/Balance_SR_HYP_05_AntGreatBow_Used"),
    ...
    ("CircGuire", "/Game/Gear/Weapons/Shotguns/Hyperion/_Shared/_Design/_Unique/CircGyre/Balance/Balance_SG_HYP_05_CircGuire"),
    ...
    ("Pirates", "/Game/Gear/Weapons/AssaultRifles/ChildrenOfTheVault/_Shared/_Design/_Unique/PiratesLife/Balance/Balance_AR_COV_Pirates"),
    ...
    ("EchoPhoenix", "/Game/PatchDLC/Indigo3/Gear/Weapons/AssualtRifles/Jakobs/_Shared/_Design/_Unique/EchoingPhoenix/Balance/Balance_AR_JAK_EchoPhoenix"),
    ...
    ("ManualTrans", "/Game/Gear/Weapons/AssaultRifles/Vladof/_Shared/_Design/_Unique/ManualTransmission/Balance/Balance_AR_VLA_ManualTrans"),
    ("Butterbm", "/Game/PatchDLC/Indigo2/Gear/Weapons/Pistols/Torgue/_Shared/_Design/_Unique/Butterboom/Balance/Balance_PS_TOR_05_Butterbm"),
    ...
    ("FacePuncher", "/Game/PatchDLC/Indigo3/Gear/Weapons/Shotgun/Hyperion/_Shared/_Design/_Unique/FaceStabber/Balance/Balance_SG_HYP_FacePuncher"),
    ...
    ("DONOTUSE", "/Game/PatchDLC/Indigo4/Gear/Weapons/AssaultRifles/Torgue/_Shared/_Design/_Unique/Vengeance/Balance/Balance_TOR_DONOTUSE"),
...
for (sname, sobj) in [
    ...
    ("LichsAugur", "/Game/PatchDLC/Indigo2/Gear/Wards/_Design/_Unique/LichsAugur/Balance/InvBalD_Shield_LichsAugur"),
]:
...
for (cname, cobj) in [
    ...
    ("SaltnBatt", "/Game/PatchDLC/Indigo2/Gear/Melee/_Shared/_Unique/SaltnBattery/Balance/Balance_M_SaltnBatt"),
    (
    ...
    ("HammerQuake", "/Game/PatchDLC/Indigo3/Gear/Melee/_Shared/_Unique/HammerQuake/Balance_M_HammerQuake"),
    ("ShieldBash", "/Game/PatchDLC/Indigo3/Gear/Melee/_Shared/_Unique/ShieldBash/Balance_M_ShieldBash"),
    ("FaceSmasher", "/Game/PatchDLC/Indigo4/Gear/Melee/_Shared/_Unique/FaceSmasher/Balance_M_FaceSmasher"),
]:
    melee_balances.append((
        cname,
        '',
...
for (cname, cobj) in [
    ...
    ("Jamstone", "/Game/PatchDLC/Indigo2/Gear/Rings/_Shared/_Unique/PreciousJamstone/Balance/Balance_Ring_Jamstone"),
]:
...
for (cname, cobj) in [
    ...
    ("GarlicBreath", "/Game/PatchDLC/Indigo2/Gear/SpellMods/_Unique/GarlicBreath/Balance/Balance_Spell_GarlicBreath"),
    ("FirstDark", "/Game/Gear/SpellMods/_Unique/_MissionUniques/FirstDarkSpell/Balance_Spell_FirstDark"),
    (
    "InstantAmbush", "/Game/PatchDLC/Indigo3/Gear/SpellMods/_Unique/InstantAmbush/Balance/Balance_Spell_InstantAmbush"),
    ("SomethingWicked",
     "/Game/PatchDLC/Indigo4/Gear/SpellMods/_Unique/SomethingWicked/Balance/Balance_Spell_SomethingWicked"),
    ("IllWrath", "/Game/PatchDLC/Indigo3/Gear/SpellMods/_Unique/IllmarinensWrath/Balance/Balance_Spell_IllWrath"),
    ("CurseOfMal", "/Game/PatchDLC/Indigo4/Gear/SpellMods/_Unique/CurseOfMalice/Balance/Balance_Spell_CurseOfMal"),
]:
    spell_balances.append((
        cname,
        '',
