...
def temp(full_filename):
    ...
    with open(full_filename, 'rb') as df:
        ...
        for _ in range(num_symbols):
            ...
            read_int(df)
    for sym in syms:
        if "Balance_SG_Torgue_Swordruption" in sym:
            print("")
...
full_filename = "C:\\Users\\gabri\\PycharmProjects\\ttwmods\\hotfixgenerator\\extracted_new\\Game\\Gear\\Weapons\\Shotguns\\Torgue\\_Shared\\_Design\\_Unique\\Swordruption\\Balance\\Balance_SG_Torgue_Swordruption.uasset"
temp(full_filename)
full_filename = "C:\\Users\\gabri\\PycharmProjects\\ttwmods\\hotfixgenerator\\extracted_new\\Game\\Gear\\Weapons\\Shotguns\\Torgue\\_Shared\\_Design\\_Unique\\Swordruption\\Balance\\PartSet_SG_Torgue_Swordruption.uasset"
temp(full_filename)
full_filename = "C:\\Users\\gabri\\PycharmProjects\\ttwmods\\hotfixgenerator\\extracted_new\\Game\\Gear\\Weapons\\Shotguns\\Torgue\\_Shared\\_Design\\_Unique\\Swordruption\\Parts\\Part_SG_Torgue_Barrel_Swordruption.uasset"
temp(full_filename)
...
# print("Part_SG_Torgue_Barrel_Swordruption.uasset in filenames: {}".format("Part_SG_Torgue_Barrel_Swordruption.uasset" in filenames))
# print("Balance_SG_Torgue_Swordruption.uasset in filenames: {}".format("Balance_SG_Torgue_Swordruption.uasset" in filenames))